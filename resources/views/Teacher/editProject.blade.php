              ...
              <div class="col-md-6">
                <div class="aa-myaccount-login">
                  ...
                  @if (Session::has('done'))
                    ...
                    @endif
                  <form class="aa-login-form" action="/project/edit" method="post" enctype="multipart/form-data">
                    @csrf
                    <label for="">Title project<span>*</span></label>
                  <input type="text" name="title" placeholder="Project Title" value="{{$project->title}}">
                  <input type="hidden" name="id"  value="{{$project->id}}">
                    <div class="form-group">
                      <label for="exampleFormControlSelect1">Student Number<span>*</span></label>
                      <select class="form-control w-50 " id="studentlist"  name="std_number">
                        <option value="{{$project->std_number}}">{{$project->std_number}}</option>
                    ...
                    <label for="">Project Field <span>*</span></label>
                    <input type="text" name="field" placeholder="Project Category" value="{{$project->field}}">
                    <label for="">Project Description<span>*</span></label>
                    <textarea name="note" rows="6" cols="62" >{{$project->note}}
                   </textarea>
                    <label for="">Project Image<span>*</span></label>
