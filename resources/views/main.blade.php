        ...
        <div class="seq-screen">
          <ul class="seq-canvas">
            ...
            <li>
              ...
              <div class="seq-title">
                <span data-seq></span>
                <h2 data-seq>Chose Your Project Onlile</h2>
                <p data-seq>.</p>
              </div>
            </li>
            <!-- single slide item -->
            <li>
              ...
              <div class="seq-title">
                <span data-seq></span>
                <h2 data-seq>Publishing Project Graduation</h2>
                <p data-seq></p>
              </div>
            </li>
            <!-- single slide item -->
            <li>
              ...
              <div class="seq-title">
                <span data-seq></span>
                <h2 data-seq>Result project accept</h2>
                <p data-seq></p>
              </div>
            </li>
            <!-- single slide item -->
            ...
            <li>
              ...
              <div class="seq-title">
                <span data-seq></span>
                <h2 data-seq>puplishing Project Graduation Onlie</h2>
                <p data-seq>.</p>
                <a data-seq href="#" class="aa-shop-now-btn aa-secondary-btn"></a>
              </div>
            </li>
          </ul>
        </div>
