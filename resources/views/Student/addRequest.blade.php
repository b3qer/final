                    ...
                    <div class="aa-product-details-area">
                        <div class="aa-product-details-content">
                                    ...
                                    <div class="aa-product-view-slider">
                                        <div id="demo-1" class="simpleLens-gallery-container">
                                            <div class="simpleLens-container">
                                                ...
                                                <div class="simpleLens-big-image-container"><img src="images/test.jpg"
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12">
                                ...
                                <div class="aa-product-view-content">
                                    <h3>Superviser : fghfg</h3>
                                    </p>
                                </div>
                                <div class="aa-product-view-content">
                                    <h3>Students Number: sdfsdfs</h3>
                                    </p>
                                </div>
                                <div class="aa-product-view-content">
                                    <h3>Descrption : sdfsdfsd</h3>
                                    </p>
                                </div>
                                <form class="aa-login-form" action="save_project2.php" method="post"
                                    enctype="multipart/form-data">
                                    <div class="aa-product-view-content">
                                        <input type="hidden" name="d1" value=" echo $row['d1']; ?>"
                                            class="form-control">
                                        <input type="hidden" name="d2" value=" echo $row['d2']; ?>"
                                            class="form-control">
                                        <input type="hidden" name="d3" value=" echo $row['d7']; ?>"
                                            class="form-control">
                                        <input type="hidden" name="d4" value=" echo ($_SESSION['username']); ?>"
                                            class="form-control">
                                    ...
                                    <a href="" class="aa-browse-btn">Login to request</a>
                            </div>
                            </form>
