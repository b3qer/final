              ...
              <div class="col-md-6">
                <div class="aa-myaccount-login">
                  ...
                  @if (Session::has('done'))
                    ...
                    @endif
                  <form class="aa-login-form" action="teacher/project" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <input type="text" name="field" placeholder="Project Field">
                    <label for="">Project Description<span>*</span></label>
                    <textarea name="note" rows="6" cols="62">
                   </textarea>
