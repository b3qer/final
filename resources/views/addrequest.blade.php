            ...
            <div class="aa-product-details-content">
                        ...
                        <div class="aa-product-view-slider">
                          <div id="demo-1" class="simpleLens-gallery-container">
                            <div class="simpleLens-container">
                              ...
                              <div class="simpleLens-big-image-container"><img src="images/echo $img = $row['d7']; " class="simpleLens-big-image" style="max-width:500px; height:400px;"></a></div>
                            </div>
              ...
              <div class="col-md-7 col-sm-7 col-xs-12">
                <div class="aa-product-view-content">
                  <h3>Title Project : echo $row['d1']; ?></h3>
                  </p>
                </div>
                <div class="aa-product-view-content">
                  <h3>Superviser : $row['d2']; ?></h3>
                  </p>
                </div>
                <div class="aa-product-view-content">
                  <h3>No. Students : echo $row['d4']; ?></h3>
                  </p>
                </div>
                <div class="aa-product-view-content">
                  <h3>Descrption :echo $row['d6']; ?></h3>
                  </p>
                </div>
                <form class="aa-login-form" action="save_project2.php" method="post" enctype="multipart/form-data">
                <div class="aa-product-view-content">
                  <input type="hidden" name="d1" value=" echo $row['d1']; ?>" class="form-control">
                  <input type="hidden" name="d2" value=" echo $row['d2']; ?>" class="form-control">
                  <input type="hidden" name="d3" value=" echo $row['d7']; ?>" class="form-control">
                  <input type="hidden" name="d4" value=" echo ($_SESSION['username']); ?>" class="form-control">
                  <div class="form-group">
                    <label for="exampleFormControlSelect1">No.Student<span>*</span></label>
                    <select class="form-control w-50 " id="studentlist" style="height:30px;" name="d5">
              ...
              <h3> <input type="submit" class="aa-browse-btn" value="Reserve the project"></h3>
