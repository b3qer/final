...
<div class="panel panel-default aa-checkout-coupon">
    ...
    <div id="collapseOne" class="panel-collapse collapse in">
        <div class="panel-body">
            ...
            <br>
            Supervisor : {{$project->teacher->name}}
            <br>
            Student Number : {{$project->std_number}}
            <br>
            ...
            <form action="/admin/accept/project" method="post">
                @csrf
            <input type="hidden" name="id" value="{{$project->id}}">
                <input type="submit" class="aa-browse-btn" value="Accept">
            </form>
